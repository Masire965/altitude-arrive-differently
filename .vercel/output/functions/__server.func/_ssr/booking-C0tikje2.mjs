...
//#region node_modules/.nitro/vite/services/ssr/assets/booking-C0tikje2.js
...
function Booking() {
	...
	if (submitted) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageHero, {
		eyebrow: "Confirmed",
		title: "Your concierge request is received.",
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "A senior concierge will be in touch shortly to confirm every detail. You will also receive WhatsApp updates leading up to your service."
				})
			]
		})
	})] });
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: isSubmitting ? "Submitting..." : "Confirm Concierge Request"
					})
				]
			})
		})
